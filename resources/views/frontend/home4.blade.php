...
<link rel="icon" type="image/png" href="{{ asset('public/img/cleint/logo.png') }}">
...
<nav class="navbar">
    <div class="logo">
        <a href="#">
            <img src="{{ asset('public/img/cleint/logo.png') }}" alt="تخيّل" class="logo-img">
        </a>
    </div>
...
<footer>
    <div class="container footer-grid">
        <div>
            <div class="footer-logo"><img src="{{ asset('public/img/cleint/logo.png') }}" alt="تخيّل" ></div>
